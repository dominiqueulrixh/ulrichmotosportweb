...
export interface ApiBrandSectionBrandSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    items: Schema.Attribute.Component<'sections.brand-card', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    cards: Schema.Attribute.Component<'sections.contact-card', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    eyebrow: Schema.Attribute.String;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    services: Schema.Attribute.Component<'sections.list-item', true>;
    socials: Schema.Attribute.Component<'sections.social-link', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    primaryCtaTarget: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    secondaryCtaLabel: Schema.Attribute.String;
    secondaryCtaTarget: Schema.Attribute.String;
    stats: Schema.Attribute.Component<'sections.hero-stat', true>;
...
export interface ApiServiceSectionServiceSection
  ...
  attributes: {
    categories: Schema.Attribute.Component<'sections.service-category', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    detailsHeading: Schema.Attribute.String;
    detailsSubheading: Schema.Attribute.Text;
    eyebrow: Schema.Attribute.String;
    heading: Schema.Attribute.String;
    items: Schema.Attribute.Component<'sections.service-card', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiTeamTeam extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::team.team'> &
      Schema.Attribute.Private;
    members: Schema.Attribute.Component<'sections.team-member', true>;
    publishedAt: Schema.Attribute.DateTime;
