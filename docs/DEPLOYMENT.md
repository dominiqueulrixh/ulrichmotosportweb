...
- `FRONTEND_API_URL` – Basis-URL der produktiven Strapi-Instanz für den Frontend-Build.
- `NAS_HOST`, `NAS_USER`, `NAS_SSH_KEY`, `NAS_DEPLOY_PATH` – SSH-Zugangsdaten und Pfad zur Compose-Datei.
